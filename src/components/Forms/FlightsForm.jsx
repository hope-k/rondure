        ...
        <div className="">
          <div className="relative w-full">
            <Select>
              ...
              <SelectContent>
                <SelectGroup>
                  <SelectLabel><span>Choose Class</span></SelectLabel>
                  <SelectItem value="apple"><span>First Class</span></SelectItem>
                  <SelectItem value="banana"><span>Business Class</span></SelectItem>
                  <SelectItem value="blueberry"><span>Premium Economy Class</span></SelectItem>
                  <SelectItem value="grapes"><span>Basic Economy</span></SelectItem>
                  <SelectItem value="pineapple"><span>Comfort Plus</span></SelectItem>
                </SelectGroup>
              </SelectContent>
            </Select>
          </div>
